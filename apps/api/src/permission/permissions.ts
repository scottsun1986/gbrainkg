...
export const DEFAULT_ROLES = [
  ...
  },
  {
    ...
    builtin: false,
    permissions: [...BASE_USER_PERMISSIONS, PERMISSIONS.ORG_READ, PERMISSIONS.ORG_USER_READ, PERMISSIONS.ORG_USER_MANAGE, PERMISSIONS.ORG_NODE_CREATE],
  },
  {
    name: '行业库管理员',
    ...
    permissions: [...BASE_USER_PERMISSIONS, PERMISSIONS.INDUSTRY_READ, PERMISSIONS.INDUSTRY_GRANT],
  },
  {
    name: '行业库创建者',
    description: '创建行业知识库并成为初始管理员',
    builtin: false,
    permissions: [...BASE_USER_PERMISSIONS, PERMISSIONS.INDUSTRY_CREATE],
  },
  {
    name: '系统管理员',
